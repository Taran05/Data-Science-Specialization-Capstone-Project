Data Science Specialization: Capstone Project (Next Word Prediction using SwiftKey Dataset)
========================================================
...
About
========================================================
- The application to predict the next word can be found [**here**] (https://taran2000.shinyapps.io/Data_Science_Specialization_Capstone_Project/)
